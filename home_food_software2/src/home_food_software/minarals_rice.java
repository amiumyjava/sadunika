...
public class minarals_rice {
    ...
    public  minarals_rice(int  RiceId ,float calcium,float chloride,float chromium,float copper,float fluoride,float Iodine,
    ...
    public int getRiceId (){return RiceId  ;}
