 ...
 * @author isuru udana
 */
public class minarals_vegetables {
    ...
    public  minarals_vegetables(int  vegetableId ,float calcium,float chloride,float chromium,float copper,float fluoride,float Iodine,
